<template>
    <div class="container py-8">
        ...
        <div class="card-list" id="chat-list">
            <a v-for="conversation in $root.conversations" v-bind:key="conversation.id"
             v-bind:href="'#' + conversation.id" @click.prevent="setConversation(conversation)" class="card border-0 text-reset">
                <div class="card-body">
                    <div class="row gx-5">
                        <div class="col-auto">
